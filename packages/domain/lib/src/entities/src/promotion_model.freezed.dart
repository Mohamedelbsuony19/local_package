...
class _$PromotionImpl implements _Promotion {
  ...
  @override
  String toString() {
    return 'Promotion(description: $description, id: $id, name: $name, type: $type)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, description, id, name, type);
...
abstract class _Promotion implements Promotion {
  factory _Promotion(
      ...
      @JsonKey(name: 'type') final String? type}) = _$PromotionImpl;

...
import 'carousel_options_plus.dart';
import 'carousel_state.dart';
import 'utils.dart';

export 'carousel_controller.dart';
export 'carousel_options_plus.dart';

typedef ExtendedIndexedWidgetBuilder = Widget Function(
    BuildContext context, int index, int realIndex);

class CarouselSliderPlus extends StatefulWidget {
  /// [CarouselOptionsPlus] to create a [CarouselState] with
  final CarouselOptionsPlus options;
  ...
  @override
  CarouselSliderPlusState createState() =>
      CarouselSliderPlusState(_carouselController);
}

class CarouselSliderPlusState extends State<CarouselSliderPlus>
    with TickerProviderStateMixin {
  final CarouselControllerImpl carouselController;
  Timer? timer;

  CarouselOptionsPlus get options => widget.options;
  ...
  CarouselSliderPlusState(this.carouselController);
  ...
  @override
  void didUpdateWidget(CarouselSliderPlus oldWidget) {
    ...
    // handle auto play when state changes
    handleAutoPlay();

...
class CarouselOptionsPlus {
  ...
  /// Pass a `Page Storage key` if you want to keep the pageview's position when it was recreated.
  ...
  ///Generate new [CarouselOptionsPlus] based on old ones.

  CarouselOptionsPlus copyWith(
          {double? height,
          double? aspectRatio,
